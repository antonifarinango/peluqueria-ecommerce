        ...
        <div className="bg-background selection:bg-primary-fixed selection:text-on-primary-fixed">
            ...
            >
                <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                    <div className="md:w-1/2 flex flex-col gap-8">
                        <span className="label-md uppercase tracking-[0.3em] text-primary font-bold text-xs">ESTABLISHED 2024</span>
                        <h1 className="font-headline text-5xl md:text-8xl text-on-surface leading-tight">Our <br /><span className="italic font-light opacity-90">Heritage.</span></h1>
                        <p className="text-secondary text-lg max-w-xl font-body leading-relaxed">
                            Founded by a collective of editorial stylists and creative directors, The Editorial Salon was born from a desire to bridge the gap between high-fashion artistry and everyday luxury.
                        </p>
                        <div className="flex gap-12 py-4">
                            <div>
                                <h4 className="text-4xl font-headline text-primary tracking-tighter">NY / LDN</h4>
                                <p className="text-[10px] uppercase tracking-widest text-secondary mt-2 Manrope font-bold">Global Roots</p>
                            </div>
                            <div>
                                <h4 className="text-4xl font-headline text-primary tracking-tighter">10k+</h4>
                                <p className="text-[10px] uppercase tracking-widest text-secondary mt-2 Manrope font-bold">Faces Styled</p>
                            </div>
                        </div>
                    </div>
            ...
            >
                <div className="max-w-screen-xl mx-auto px-8 text-center flex flex-col items-center gap-10">
                    ...
                    <h2 className="font-headline text-4xl md:text-6xl text-on-surface">The Gilt Standard</h2>
                    <p className="text-secondary text-xl max-w-3xl font-body leading-relaxed">
                        We don't just cut hair; we engineer silhouettes. Every appointment starts with a comprehensive face-mapping and texture analysis to ensure your style is as unique as your genome.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full mt-10">
                        <div className="flex flex-col gap-4 items-center">
                            <FiScissors className="text-3xl text-primary" />
                            <h4 className="font-headline text-xl">Architectural Cut</h4>
                            <p className="text-sm text-secondary font-body">Designed to grow out perfectly over 8-12 weeks.</p>
                        </div>
                        <div className="flex flex-col gap-4 items-center">
                            <FiTriangle className="text-3xl text-primary" />
                            <h4 className="font-headline text-xl">Texture Sync</h4>
                            <p className="text-sm text-secondary font-body">Specific products mapped to your biological hair type.</p>
                        </div>
                        <div className="flex flex-col gap-4 items-center">
                            <FiStar className="text-3xl text-primary" />
                            <h4 className="font-headline text-xl">Quiet Luxury</h4>
                            <p className="text-sm text-secondary font-body">An environment designed for peak sensory relaxation.</p>
                        </div>
                    </div>
                </div>
            </motion.section>
            ...
            >
                <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
                    <div className="bg-surface-container-high p-12 md:p-20 rounded-sm">
                        <h2 className="font-headline text-4xl mb-12 text-on-surface">Visit the Sanctuary</h2>
                        <div className="flex flex-col gap-10">
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h4 className="font-headline text-xl mb-2">The Fifth Avenue Studio</h4>
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h4 className="font-headline text-xl mb-2">Private Concierge</h4>
                            ...
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    <h4 className="font-headline text-xl mb-2">General Inquiries</h4>
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        ...
                        <div className="p-10 border-l-8 border-primary bg-surface-container-low italic">
                            <p className="text-2xl font-headline text-on-surface mb-4">"Hair is the only accessory you never take off. We make sure it's the right one."</p>
                            <cite className="font-bold Manrope text-xs tracking-widest uppercase text-secondary">— ELARA VANCE, FOUNDING DIRECTOR</cite>
                        </div>
                    </div>
                </div>
            </motion.section>
            ...
            <section className="py-40 bg-on-surface text-center px-8">
                <div className="max-w-3xl mx-auto flex flex-col items-center">
                    <h2 className="font-headline text-5xl md:text-7xl mb-12 text-surface leading-tight tracking-tighter">Shape your <br /><span className="italic font-light opacity-80">own future.</span></h2>
                    ...
                    <p className="mt-8 text-surface/40 text-xs font-bold tracking-widest uppercase Manrope">Limited appointments available per month.</p>
                </div>
            </section>
        </div>
    );
